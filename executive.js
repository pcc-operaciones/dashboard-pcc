...
function render(){
 ...
 if(!issues.length)list.append(e('p',current.areas.some(a=>a.status==='Consultando')?'Consultando las áreas. Los asuntos aparecerán al completar las cargas.':'No se detectaron desvíos en las reglas disponibles. Revisa también el detalle de cada área.','gg-empty'));
 $('gg-issue-count').textContent=issues.length+' asuntos';
