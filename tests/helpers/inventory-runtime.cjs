...
function runtime(){
 ...
 vm.runInContext(fs.readFileSync('inventory-history-model.js','utf8'),ctx);vm.runInContext(fs.readFileSync('apps-script/inventory-history/Valuation.gs','utf8'),ctx);vm.runInContext(fs.readFileSync('apps-script/inventory-history/Publication.gs','utf8'),ctx);
