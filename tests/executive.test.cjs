...
test('el total gerencial incluye todas las bodegas y la antigüedad conserva su alcance principal',()=>{assert.deepEqual(M.inventorySummary([{u0:10,u1:20,u2:30,u3:40},{esSeg:true,u0:1000},{esCobros:true,u3:1000}]),{units:2100,aged:40,agedShare:.4});});
